...
#define GPIOA_MODER_PA5 (5*2) //access IDX to LD2 button
#define GPIOA_BSRR_SET_PA5_IDX 5 //access IDX to SET PA5 BSRR
#define GPIOA_BSRR_RESET_PA5_IDX 21 //access IDX to RESET PA5 BSRR

//PUSH BUTTON DEFINES
#define GPIOC_CLK_EN (1U << 2)
#define GPIOC_MODER_PC13_IDX (13*2) //access IDX to USER push button
#define GPIOC_IDR_PC13_IDX 13 //access to set input value for PC13
...
int main(void)
{
     ...
     * */
    //configure PA5 to be an output register
    GPIOA->MODER &= ~(3U << GPIOA_MODER_PA5);
    GPIOA->MODER |= (1U << GPIOA_MODER_PA5);
